...
foreach ($list as $key => $value) {
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G' . $key, ' ' . $value['storeNum']);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H' . $key, ' ' . $value['salePrice'] * $value['storeNum']);
}
...
$objPHPExcel->getActiveSheet()->setTitle('商品库存');
...
header('Content-Disposition: attachment;filename="商品库存.xls"');//导出文件
