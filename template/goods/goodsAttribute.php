			...
			<div class="wbox">
				<div class="wbox-title">
					...
					<div class="ibox-tools">
						<a class="btn-blue add-btn" href="javascript:;">添加</a>
						<a class="btn-green" href="javascript:;">导出</a>
						<a class="btn-blue" href="javascript:;">导入</a>
						<a class="btn-delete" href="javascript:;"><i class="iconfont will-huishou"></i></a>
							...
							<tbody>
								<tr class="text-c">
									...
									<td>
										...
										<a class="btn-red del-btn" href="javascript:;">删除</a>
									</td>
								</tr>
								<tr class="text-c">
