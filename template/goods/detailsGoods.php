...
$dataUnit = array('datas' => array('stoId' => $_SESSION['stoId'], 'state' => '1'));
            ...
            <div class="wbox-content article-goods">
                <form class="layui-form layui-form-pane" id='myupload' action='../../Controller/goods/upload.php' method='post' enctype='multipart/form-data'>
                        ...
                        <div class="layui-inline">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 224px;">
                                    <input type="text" class="layui-input" ng-model="GoodName" placeholder="请输入商品名称" autocomplete="off">
                                </div>
                            </div>
                            <div class="layui-form-item" style="margin-top: 10px;">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline" style="width: 224px;">
                                        <select class="layui-select" ng-model="GoodsCategory">
                            ...
                            <div class="layui-form-item" style="margin-top: 10px;">
                                ...
                                <div class="layui-input-inline" style="width: 224px;">
                                    <select class="layui-select" ng-model="GoodUnit">
                            ...
                            <div class="layui-form-item" style="margin-top: 10px;">
                                ...
                                <div class="layui-input-inline" style="width: 224px;">
                                    <input type="text" class="layui-input" placeholder="请输入商品保质期" ng-model="LaterTime" autocomplete="off">
                                </div>
                            </div>
                            <div class="layui-form-item" style="margin-top: 10px;">
                                <label class="layui-form-label">条形码</label>
                                <div class="layui-input-inline" style="width: 224px;">
                                    <input type="text" class="layui-input" placeholder="请输入商品条形码" ng-model="barCode" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="layui-inline">
                            <div class="article-img">
                                ...
                                <input type="button" onclick="upload.click()" class="img-btn" value="上传图片"/>
                            </div>
                        </div>
                        <div class="layui-form-item" style="margin-top: 10px;">
                            <div class="layui-inline">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block" style="width: 60px;margin-left: 80px;">
                                    <div ng-class="{true: 'will-check active', false: 'will-check'}[stockManage]">
                                        <input type="checkbox" ng-checked="stockManage" ng-click="changeClass('stockManage')"/>
                                        <i class="iconfont"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block" style="width: 60px;margin-left: 80px;">
                                    <div ng-class="{true: 'will-check active', false: 'will-check'}[temporary]">
                                        <input type="checkbox" ng-checked="temporary" ng-click="changeClass('temporary')"/>
                                        <i class="iconfont"></i>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="layui-form-item" style="margin-top: 10px;">
                                ...
                                <tr class="text-c">
                                    ...
                                    <td>
                                        <div ng-class="{true: 'will-check active', false: 'will-check'}[isPrice]">
                                            <input type="checkbox" ng-checked="isPrice" ng-click="changeClass('isPrice')"/>
                                            <i class="iconfont"></i>
                                        </div>
                                    </td>
                                    <td>
                                        <div ng-class="{true: 'will-check active', false: 'will-check'}[isStore]">
                                            <input type="checkbox" ng-checked="isStore" ng-click="changeClass('isStore')"/>
                                            <i class="iconfont"></i>
                                        </div>
                                    </td>
                                    <td>
                                        <div ng-class="{true: 'will-check active', false: 'will-check'}[isIntegral]">
                                            <input type="checkbox" ng-checked="isIntegral" ng-click="changeClass('isIntegral')"/>
                                            <i class="iconfont"></i>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="text-c" id="tab-len" ng-repeat="i in range(num) track by $index">
                                    <td><input type="text" class="layui-input" ng-model="$parent.standard[$index]" placeholder="规格" autocomplete="off"></td>
                                    <td><input type="text" class="layui-input" ng-model="$parent.purchaseing[$index]" placeholder="进价" autocomplete="off"
                                    ...
                                    <td><input type="text" class="layui-input" ng-model="$parent.collect[$index]" placeholder="收银价" ng-show="isPrice"
                                               ng-change="checkNum2(this.collect[$index],$index)"
                                               autocomplete="off" onkeyup="if(isNaN(value))execCommand('undo')"
                                               onafterpaste="if(isNaN(value))execCommand('undo')"></td>
                                    <td><input type="text" class="layui-input" ng-model="$parent.shopping[$index]" placeholder="商城价" ng-show="isStore"
                                               ng-change="checkNum3(this.shopping[$index],$index)"
                                               autocomplete="off" onkeyup="if(isNaN(value))execCommand('undo')"
                                               onafterpaste="if(isNaN(value))execCommand('undo')"></td>
                                    <td><input type="text" class="layui-input" ng-model="$parent.integration[$index]" placeholder="积分价" ng-show="isIntegral"
                        ...
                        <div class="layui-form-item tab-btn" style="margin-top: -5px;">
