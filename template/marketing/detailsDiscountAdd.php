            ...
            <div class="wbox-content details-discount">
                <form class="layui-form layui-form-pane">
                    ...
                    <div class="scope-goods" ng-show="discountType">
                        ...
                        <div class="sg-content">
                            <div class="sg-category">
                                <ul ng-repeat="item in list | unique:'catId'">
                            ...
                            <div class="sg-list">
                                <ul>
                                    <li ng-repeat="items in list | filter:{'catId':active}:true">
                                        <label>
                    ...
                    <div class="layui-form-item" style="margin-top: 15px;">
                        <input type="button" class="layui-btn layui-btn-small layui-btn-normal details-button" value="保存" ng-click="saveModal()"/>
