    ...
    <div class="popup new-open" id="add">
        <form class="layui-form">
            <div class="layui-form-item">
                <label class="layui-form-label">免单原因</label>
                <div class="layui-input-inline" style="width: 250px;">
                    <input name="title" placeholder="请输入免单原因" class="layui-input" ng-model="name" type="text" autocomplete="off">
                </div>
            </div>
...
<script type="text/javascript">
    ...
    app.controller('listController', function ($scope, $http) {
        var reSearch = function () {
            ...
            $http.post('../../Controller/marketing/listMiandanAction.php', postData).then(function (result) {  //正确请求成功时处理
        ...
        $scope.addModal = function (name, id) {
            if (name != '') {
                $scope.name = name;
                $scope.mid = id;
            } else {
        ...
        $scope.deleteModal = function (id) {
            layer.alert('您确定删除该免单原因吗？', {icon: 5, title: "删除", resize: false,}, function (index) {
                var postData = {
                    type: 'delete',
                    dId: id,
                };
