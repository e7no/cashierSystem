            ...
            <div class="wbox-content">
                <div class="con-table">
                    <table class="layui-table" style="min-width: 1200px;">
                        ...
                        <tr class="text-c">
                            <th width="15%">单据编码</th>
                            <th width="12%">报废总数量</th>
                            <th width="12%">报废总金额</th>
                            <th width="13%">报废时间</th>
                            <th width="15%">备注</th>
                            <th width="8%">报废员</th>
                            <th width="8%">操作员</th>
    ...
    app.controller('listController', function ($scope, $http) {
        ...
        $scope.checkDetail = function (id) {
            layer.open({
                ...
                shadeClose: true,
                offset: ['0', '0'],
                content: 'detailsMaterialScrap.php?id=' + id,
            });
        }
        $('#excel').click(function () {
            ...
            window.location.href = '../../Controller/Excel/listMaterialScrapExcel.php?no=' + no + '&scrapDateStart=' + scrapDateStart + '&scrapDateEnd=' + scrapDateEnd + '&operator=' + operator;
        });
    });
</script>
</body>
