            ...
            <div class="wbox-content">
                <form>
                    <div class="cprk-box">
                        ...
                        <span>领用总量：{{outStockInfo.quantity}}</span>
                        <span>领用总额：{{outStockInfo.sum}}</span>
                        <span>领用时间：{{outStockInfo.outDate}}</span>
                        <span ng-if="outStockInfo.type==1">领用类型：生产领用</span>
                        <span ng-if="outStockInfo.type==2">领用类型：其它领用</span>
                        <span>采购员：{{outStockInfo.personName}}</span>
                    </div>
                    <div class="con-table">
...
<script type="text/javascript">
    ...
    app.controller('listController', function ($scope, $http) {
        ...
        $('#excel').click(function () {
            ...
            window.location.href = '../../Controller/Excel/detailsMaterialReceiveExcel.php?id=' + id;
        });
    });
</script>
</body>
