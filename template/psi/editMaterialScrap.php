                ...
                <form class="layui-form layui-form-pane psi-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width: 120px;">
                                <input type="text" class="layui-input" placeholder="请输入报废员姓名" ng-model="name">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-top: 10px;">
                        ...
                        <div class="layui-input-inline" style="width: 380px;">
                            <input type="text" class="layui-input" placeholder="请输入原料报废备注" ng-model="note">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-top: 10px;">
                        <input type="button" class="layui-btn layui-btn-small layui-btn-normal put-btn" disabled="disabled" value="报废"  ng-show="!readDrivingUnable" ng-click="getModal()">
                        <input type="button" class="layui-btn layui-btn-small layui-btn-normal put-btn" value="报废" ng-show="readDrivingUnable" ng-click="getModal()">
