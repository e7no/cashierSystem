...
//$arr = json_decode($_GET["datas"], true);
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper" ng-controller="listController">
	...
	<form action="editGoodsReceive.php" id="sub" method="post" target="_parent">
...
app.controller('listController', function ($scope, $http) {
    ...
    $http.post('../../Controller/psi/addGoodsStorageAction.php', postData).then(function (result) {  //正确请求成功时处理
        ...
        var datas = '<?php echo $_SESSION["datas"];?>';
    	if(datas==""){
    		$scope.list = [];
    	}else{
    ...
    $scope.AddGoods = function(){
        ...
        //parent.location.href='editGoodsReceive.php?datas='+postData+'&type=list';
    }
